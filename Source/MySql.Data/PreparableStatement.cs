...
namespace MySql.Data.MySqlClient {
    ...
    internal class PreparableStatement : Statement {
        ...
        public virtual void Prepare() {
            ...
            string text;
            var parameterNames = PrepareCommandText( out text );
            ...
            for ( var i = 0; i < parameterNames.Count; i++ ) {
                ...
                var p = Parameters.GetParameterFlexible( parameterName, false );
                if ( p == null ) throw new InvalidOperationException( String.Format( Resources.ParameterNotFoundDuringPrepare, parameterName ) );
            ...
            _packet.WriteByte( 0 ); // flags; always 0 for 4.1
            ...
            foreach ( var p in _parametersToSend ) _packet.WriteInteger( p.GetPsType(), 2 );
        ...
        public override void Execute() {
            ...
            for ( var i = 0; i < _parametersToSend.Count; i++ ) {
                var p = _parametersToSend[ i ];
                _nullMap[ i ] = ( p.Value == DBNull.Value || p.Value == null ) || p.Direction == ParameterDirection.Output;
        ...
        public override bool ExecuteNext() {
            if ( !IsPrepared ) return base.ExecuteNext();
            return false;
        }
        ...
        /// </remarks>
        private List<string> PrepareCommandText( out string strippedSql ) {
