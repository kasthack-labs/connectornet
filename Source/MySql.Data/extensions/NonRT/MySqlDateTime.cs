...
namespace MySql.Data.Types {
    ...
    public partial struct MySqlDateTime : IConvertible {
        ...
        ulong IConvertible.ToUInt64( IFormatProvider provider ) => 0;

        // TODO:  Add MySqlDateTime.ToSByte implementation
        sbyte IConvertible.ToSByte( IFormatProvider provider ) => 0;

        double IConvertible.ToDouble( IFormatProvider provider ) => 0;

        DateTime IConvertible.ToDateTime( IFormatProvider provider ) => GetDateTime();

        float IConvertible.ToSingle( IFormatProvider provider ) => 0;
        ...
        long IConvertible.ToInt64( IFormatProvider provider ) => 0;

        TypeCode IConvertible.GetTypeCode() => new TypeCode();

        decimal IConvertible.ToDecimal( IFormatProvider provider ) => 0;

        object IConvertible.ToType( Type conversionType, IFormatProvider provider ) => null;

        uint IConvertible.ToUInt32( IFormatProvider provider ) => 0;
        #endregion
    }
}