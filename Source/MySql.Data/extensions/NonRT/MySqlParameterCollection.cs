...
namespace MySql.Data.MySqlClient {
    ...
    public sealed partial class MySqlParameterCollection : DbParameterCollection {
        ...
        public override int Add( object value ) {
            ...
            if ( parameter == null ) throw new MySqlException( "Only MySqlParameter objects may be stored" );
        ...
        /// has a fixed size. 
        /// </summary>
        public override bool IsFixedSize => ( _items as IList ).IsFixedSize;

        /// <summary>
        /// Gets a value that indicates whether the <see cref="MySqlParameterCollection"/>
        /// is read-only. 
        /// </summary>
        public override bool IsReadOnly => ( _items as IList ).IsReadOnly;

        /// <summary>
        /// Gets a value that indicates whether the <see cref="MySqlParameterCollection"/>
        /// is synchronized. 
        /// </summary>
        public override bool IsSynchronized => ( _items as IList ).IsSynchronized;
