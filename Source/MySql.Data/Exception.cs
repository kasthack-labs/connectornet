...
namespace MySql.Data.MySqlClient {
    ...
    public sealed class MySqlException : DbException {
        ...
        internal MySqlException( string msg, bool isFatal, Exception inner ) : base( msg, inner ) { this.IsFatal = isFatal; }
        ...
        internal bool IsQueryAborted
            => ( Number == (int) MySqlErrorCode.QueryInterrupted || Number == (int) MySqlErrorCode.FileSortAborted );
    }
}