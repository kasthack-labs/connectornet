...
namespace MySql.Data.MySqlClient {
    ...
    public abstract class BaseCommandInterceptor {
        ...
        public virtual bool ExecuteScalar( string sql, ref object returnValue ) => false;

        public virtual bool ExecuteNonQuery( string sql, ref int returnValue ) => false;

        public virtual bool ExecuteReader( string sql, CommandBehavior behavior, ref MySqlDataReader returnValue ) => false;

        public virtual void Init( MySqlConnection connection ) { ActiveConnection = connection; }
    }
