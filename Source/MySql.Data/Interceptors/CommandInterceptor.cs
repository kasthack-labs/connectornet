...
namespace MySql.Data.MySqlClient {
    ...
    public abstract class BaseCommandInterceptor {
        ...
        public virtual bool ExecuteScalar( string sql, ref object returnValue ) { return false; }

        public virtual bool ExecuteNonQuery( string sql, ref int returnValue ) { return false; }
